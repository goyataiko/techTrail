...
<head>
    ...
    <title>Reset Passwrod &mdash; Tech Trail</title>
                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="{{secure_asset('assets/img/logo.png')}}" alt="logo" width="150">
                        </div>
                        ...
                        <div class="card card-primary mt-5">
                            ...
                            <div class="card-body pt-0">
                                <form method="POST" action="{{ route('password.store') }}" class="needs-validation" novalidate="">@csrf
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="email" type="email" value="{{ $request-> email }}" class="form-control" name="email" tabindex="1" required>
                                        @if($errors->has('email'))
