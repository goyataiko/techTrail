...
<head>
    ...
    <title>Forgot Password &mdash; Tech Trail</title>
                    ...
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        ...
                        <div class="card card-primary mt-5">
                            ...
                            <div class="card-body pt-0">
                                <p>No problem. We will email you a password reset link to choose a new one.</p>
                                @if(session('status'))
                                <p class="text-success">{{session('status')}}</p>
                                @endif
                                <form method="POST" action="{{ route('password.email') }}" class="needs-validation" novalidate="">@csrf
